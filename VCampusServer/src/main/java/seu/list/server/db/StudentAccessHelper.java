...
public class StudentAccessHelper{
	...
	public int add(Connection connection, Student stu) throws Exception{
		...
		ps.setString(0, stu.getStudentid());
		ps.setString(1, stu.getStudentName());
		ps.setString(2, stu.getTeacherid());
		ps.setString(3, stu.getClassid());
		ps.setString(4, stu.getMajor());
		ps.setString(5, stu.getStudentorigion());
		ps.setString(6, stu.getStudentstatus());
		ps.setBoolean(7, stu.getStudentgender());
		ps.setString(8, stu.getStudentphone());
		ps.setDouble(9, stu.getStudentcredit());
