...
//		ImageIcon image=new ImageIcon("src/main/resources/image/P3.jpg"); 
		ImageIcon image=new ImageIcon(this.getClass().getResource("/resources/image/P3.jpg"));
...
//		findButton.setIcon(new ImageIcon("src/main/resources/image/lib_button_search.png"));
		findButton.setIcon(new ImageIcon(this.getClass().getResource("/resources/image/lib_button_search.png")));
