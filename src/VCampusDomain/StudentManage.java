...
public class StudentManage implements Serializable {
    ...
    public StudentManage(String studentID, String name, String Teacher, String classID, String Major, String origin, String status, Boolean gender, String phone, double credit) {
        this.classid = classID;
